...
int main(void)
{
  ...
  // const glm::ivec2   shape = {4096, 4096};
  const glm::ivec2 shape = {13, 7};
  const glm::vec2  res = {1.f, 2.f};
  int              seed = 0;
  ...
  hmap::Array zn0(glm::ivec2(256, 256));
  hmap::Array zn1(glm::ivec2(1024, 256));

  hmap::interpolate_array_nearest(z, zn0);
  hmap::interpolate_array_nearest(z, zn1);

  hmap::Array zn0_gpu(glm::ivec2(256, 256));
  hmap::Array zn1_gpu(glm::ivec2(1024, 256));
  ...
  hmap::Array zb0(glm::ivec2(256, 256));
  hmap::Array zb1(glm::ivec2(1024, 256));

  hmap::interpolate_array_bilinear(z, zb0);
  hmap::interpolate_array_bilinear(z, zb1);

  hmap::Array zb0_gpu(glm::ivec2(256, 256));
  hmap::Array zb1_gpu(glm::ivec2(1024, 256));
  ...
  hmap::Array zc0(glm::ivec2(256, 256));
  hmap::Array zc1(glm::ivec2(1024, 256));

  hmap::interpolate_array_bicubic(z, zc0);
  hmap::interpolate_array_bicubic(z, zc1);

  hmap::Array zc0_gpu(glm::ivec2(256, 256));
  hmap::Array zc1_gpu(glm::ivec2(1024, 256));
  ...
  hmap::Array zl0_gpu(glm::ivec2(256, 256));
  hmap::Array zl1_gpu(glm::ivec2(1024, 256));
  ...
  glm::vec4 bbox_s(1.f, 2.f, -1.f, 0.f);
  glm::vec4 bbox_t(1.25f, 1.75f, -0.75f, 0.25f);
  // glm::vec4 bbox_t(1.25f, 1.75f, -0.75f, -0.25f);

  // nearest
  hmap::Array z_bbox_n(glm::ivec2(1024, 256));
  hmap::interpolate_array_nearest(z, z_bbox_n, bbox_s, bbox_t);

  hmap::Array z_bbox_n_gpu(glm::ivec2(1024, 256));
  ...
  // linear
  hmap::Array z_bbox_b(glm::ivec2(1024, 256));
  hmap::interpolate_array_bilinear(z, z_bbox_b, bbox_s, bbox_t);

  hmap::Array z_bbox_b_gpu(glm::ivec2(1024, 256));
  ...
  // cubic
  hmap::Array z_bbox_c(glm::ivec2(1024, 256));
  hmap::interpolate_array_bicubic(z, z_bbox_c, bbox_s, bbox_t);

  hmap::Array z_bbox_c_gpu(glm::ivec2(1024, 256));
