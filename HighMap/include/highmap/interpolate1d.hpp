...
public:
/**
 * @brief Constructs an `Interpolator1D` object with the given data and method.
 *
 * This constructor initializes the interpolation object with the provided x and
 * y data points and the specified interpolation method.
 *
 ...
 *                two points. An exception is also thrown if the method requires
 ...
 *
 * This function computes the interpolated y value corresponding to the given x
 * coordinate using the previously specified interpolation method.
 *
 * @param  x The x coordinate at which to interpolate.
