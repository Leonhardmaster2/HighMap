    ...
    DistanceFunctionAxis dfa)
{
  ...
  switch (dfa)
  {
  case DistanceFunctionAxis::DFA_X:
  {
    switch (dist_fct)
    {
    ...
    case DistanceFunction::MANHATTAN:
      r_fct = [](float x, float) { return std::abs(x); };
      break;
    }
  }
  break;

  case DistanceFunctionAxis::DFA_Y:
  {
    switch (dist_fct)
    {
    case DistanceFunction::CHEBYSHEV:
    ...
    case DistanceFunction::EUCLISHEV:
    case DistanceFunction::MANHATTAN:
      r_fct = [](float, float y) { return std::abs(y); };
      break;
    }
  }
  break;

  case DistanceFunctionAxis::DFA_XY:
  {
    switch (dist_fct)
    {
    case DistanceFunction::CHEBYSHEV:
