...
\DoxyCodeLine{00259\ }
\DoxyCodeLine{00269\ Array\ \mbox{\hyperlink{namespacehmap_a339d883dc34fc818dd25077c5daab953}{is\_non\_zero}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00270\ }
\DoxyCodeLine{00280\ Array\ \mbox{\hyperlink{namespacehmap_a3a1e261b646c9df967e78fb77e5bf8c1}{is\_zero}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00281\ }
\DoxyCodeLine{00290\ Array\ \mbox{\hyperlink{namespacehmap_ac14815cf025b7430d31d08125a5c6f0d}{lerp}}(\textcolor{keyword}{const}\ Array\ \&array1,\ \textcolor{keyword}{const}\ Array\ \&array2,\ \textcolor{keyword}{const}\ Array\ \&t);}
\DoxyCodeLine{00291\ Array\ \mbox{\hyperlink{namespacehmap_ac14815cf025b7430d31d08125a5c6f0d}{lerp}}(\textcolor{keyword}{const}\ Array\ \&array1,\ \textcolor{keyword}{const}\ Array\ \&array2,\ \textcolor{keywordtype}{float}\ t);\ }
\DoxyCodeLine{00292\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ac14815cf025b7430d31d08125a5c6f0d}{lerp}}(\textcolor{keywordtype}{float}\ a,\ \textcolor{keywordtype}{float}\ b,\ \textcolor{keywordtype}{float}\ t);\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00293\ }
\DoxyCodeLine{00300\ Array\ \mbox{\hyperlink{namespacehmap_a75475b6109023ce0ad64f6f9f7c4c525}{log10}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00301\ }
\DoxyCodeLine{00308\ Array\ \mbox{\hyperlink{namespacehmap_a105e497c433e14b4235534ae6d2b87b9}{pow}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aad00066161ccf5ba4d6f93ab48c10876}{exp}});}
\DoxyCodeLine{00309\ }
\DoxyCodeLine{00326\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacehmap_a94c9fa82f2922778970f85c384ed5bd9}{radial\_displacement\_to\_xy}}(\textcolor{keyword}{const}\ Array\ \&dr,}
\DoxyCodeLine{00327\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Array\ \ \ \ \ \ \ \&dx,}
\DoxyCodeLine{00328\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Array\ \ \ \ \ \ \ \&dy,}
\DoxyCodeLine{00329\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ smoothing\ =\ 1.f,}
\DoxyCodeLine{00330\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Vec2<float>\ \ center\ =\ \{0.5f,\ 0.5f\},}
\DoxyCodeLine{00331\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Vec4<float>\ \ bbox\ =\ \{0.f,\ 1.f,\ 0.f,\ 1.f\});}
\DoxyCodeLine{00332\ }
\DoxyCodeLine{00347\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacehmap_ad2d28babba03ed11cf115ab08009de64}{rotate\_displacement}}(\textcolor{keyword}{const}\ Array\ \&delta,\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aac71bb6c14edc17967957f7918acdbdd}{angle}},\ Array\ \&dx,\ Array\ \&dy);}
\DoxyCodeLine{00348\ }
\DoxyCodeLine{00373\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ad0759b7e3cb7455527b9b5b4947720bd}{sigmoid}}(\textcolor{keywordtype}{float}\ x,}
\DoxyCodeLine{00374\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ width\ =\ 1.f,}
\DoxyCodeLine{00375\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,}
\DoxyCodeLine{00376\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f,}
\DoxyCodeLine{00377\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ x0\ =\ 0.f);}
\DoxyCodeLine{00378\ }
\DoxyCodeLine{00404\ Array\ \mbox{\hyperlink{namespacehmap_ad0759b7e3cb7455527b9b5b4947720bd}{sigmoid}}(\textcolor{keyword}{const}\ Array\ \&array,}
\DoxyCodeLine{00405\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ width\ =\ 1.f,}
\DoxyCodeLine{00406\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ vmin\ =\ 0.f,}
\DoxyCodeLine{00407\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ vmax\ =\ 1.f,}
\DoxyCodeLine{00408\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ x0\ =\ 0.f);}
\DoxyCodeLine{00409\ }
\DoxyCodeLine{00416\ Array\ \mbox{\hyperlink{namespacehmap_a03359e722d96524598aa525022317c95}{sin}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00417\ }
\DoxyCodeLine{00432\ Array\ \mbox{\hyperlink{namespacehmap_a413648e2595721d8ba4096357dbb1f84}{smoothstep3}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,\ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f);}
\DoxyCodeLine{00433\ }
\DoxyCodeLine{00440\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_a413648e2595721d8ba4096357dbb1f84}{smoothstep3}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00441\ }
\DoxyCodeLine{00449\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_a4c21ef9d4f7d33f2413c7fe391b86253}{smoothstep3\_lower}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00450\ Array\ \mbox{\hyperlink{namespacehmap_a4c21ef9d4f7d33f2413c7fe391b86253}{smoothstep3\_lower}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00451\ }
\DoxyCodeLine{00459\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_af23a6099bd3307b408f17d2346ab3d3f}{smoothstep3\_upper}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00460\ Array\ \mbox{\hyperlink{namespacehmap_af23a6099bd3307b408f17d2346ab3d3f}{smoothstep3\_upper}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00461\ }
\DoxyCodeLine{00476\ Array\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,\ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f);}
\DoxyCodeLine{00477\ Array\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keyword}{const}\ Array\ \&array,}
\DoxyCodeLine{00478\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Array\ \&vmin,}
\DoxyCodeLine{00479\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Array\ \&vmax);\ }
\DoxyCodeLine{00480\ }
\DoxyCodeLine{00487\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00488\ }
\DoxyCodeLine{00496\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ac3a402abb2905ac02f1756c0b36e971c}{smoothstep5\_lower}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00497\ Array\ \mbox{\hyperlink{namespacehmap_ac3a402abb2905ac02f1756c0b36e971c}{smoothstep5\_lower}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00498\ }
\DoxyCodeLine{00506\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aae372587e98d5acb969a89a5f0661019}{smoothstep5\_upper}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00507\ Array\ \mbox{\hyperlink{namespacehmap_aae372587e98d5acb969a89a5f0661019}{smoothstep5\_upper}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00508\ }
\DoxyCodeLine{00515\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ae7d9d43c2cd453af7a6395cbcb2ac3b2}{smoothstep7}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00516\ Array\ \mbox{\hyperlink{namespacehmap_ae7d9d43c2cd453af7a6395cbcb2ac3b2}{smoothstep7}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00517\ }
\DoxyCodeLine{00524\ Array\ \mbox{\hyperlink{namespacehmap_a6b608e2826c1f9ba54a0e8922d5faa6b}{sqrt}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00525\ }
\DoxyCodeLine{00526\ Array\ \mbox{\hyperlink{namespacehmap_a30e6961ce99edeb86af6f4ce61651bd0}{sqrt\_safe}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00527\ }
\DoxyCodeLine{00528\ \}\ \textcolor{comment}{//\ namespace\ hmap}}
