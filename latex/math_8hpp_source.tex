...
\DoxyCodeLine{00310\ }
\DoxyCodeLine{00325\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{namespacehmap_ad2d28babba03ed11cf115ab08009de64}{rotate\_displacement}}(\textcolor{keyword}{const}\ Array\ \&delta,\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aac71bb6c14edc17967957f7918acdbdd}{angle}},\ Array\ \&dx,\ Array\ \&dy);}
\DoxyCodeLine{00326\ }
\DoxyCodeLine{00351\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ad0759b7e3cb7455527b9b5b4947720bd}{sigmoid}}(\textcolor{keywordtype}{float}\ x,}
\DoxyCodeLine{00352\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ width\ =\ 1.f,}
\DoxyCodeLine{00353\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,}
\DoxyCodeLine{00354\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f,}
\DoxyCodeLine{00355\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ x0\ =\ 0.f);}
\DoxyCodeLine{00356\ }
\DoxyCodeLine{00382\ Array\ \mbox{\hyperlink{namespacehmap_ad0759b7e3cb7455527b9b5b4947720bd}{sigmoid}}(\textcolor{keyword}{const}\ Array\ \&array,}
\DoxyCodeLine{00383\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ width\ =\ 1.f,}
\DoxyCodeLine{00384\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ vmin\ =\ 0.f,}
\DoxyCodeLine{00385\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ vmax\ =\ 1.f,}
\DoxyCodeLine{00386\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ x0\ =\ 0.f);}
\DoxyCodeLine{00387\ }
\DoxyCodeLine{00394\ Array\ \mbox{\hyperlink{namespacehmap_a03359e722d96524598aa525022317c95}{sin}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00395\ }
\DoxyCodeLine{00410\ Array\ \mbox{\hyperlink{namespacehmap_a413648e2595721d8ba4096357dbb1f84}{smoothstep3}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,\ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f);}
\DoxyCodeLine{00411\ }
\DoxyCodeLine{00418\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_a413648e2595721d8ba4096357dbb1f84}{smoothstep3}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00419\ }
\DoxyCodeLine{00427\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_a4c21ef9d4f7d33f2413c7fe391b86253}{smoothstep3\_lower}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00428\ Array\ \mbox{\hyperlink{namespacehmap_a4c21ef9d4f7d33f2413c7fe391b86253}{smoothstep3\_lower}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00429\ }
\DoxyCodeLine{00437\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_af23a6099bd3307b408f17d2346ab3d3f}{smoothstep3\_upper}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00438\ Array\ \mbox{\hyperlink{namespacehmap_af23a6099bd3307b408f17d2346ab3d3f}{smoothstep3\_upper}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00439\ }
\DoxyCodeLine{00454\ Array\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,\ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f);}
\DoxyCodeLine{00455\ Array\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keyword}{const}\ Array\ \&array,}
\DoxyCodeLine{00456\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Array\ \&vmin,}
\DoxyCodeLine{00457\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Array\ \&vmax);\ }
\DoxyCodeLine{00458\ }
\DoxyCodeLine{00465\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00466\ }
\DoxyCodeLine{00474\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ac3a402abb2905ac02f1756c0b36e971c}{smoothstep5\_lower}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00475\ Array\ \mbox{\hyperlink{namespacehmap_ac3a402abb2905ac02f1756c0b36e971c}{smoothstep5\_lower}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00476\ }
\DoxyCodeLine{00484\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aae372587e98d5acb969a89a5f0661019}{smoothstep5\_upper}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00485\ Array\ \mbox{\hyperlink{namespacehmap_aae372587e98d5acb969a89a5f0661019}{smoothstep5\_upper}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00486\ }
\DoxyCodeLine{00493\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ae7d9d43c2cd453af7a6395cbcb2ac3b2}{smoothstep7}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00494\ Array\ \mbox{\hyperlink{namespacehmap_ae7d9d43c2cd453af7a6395cbcb2ac3b2}{smoothstep7}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00495\ }
\DoxyCodeLine{00502\ Array\ \mbox{\hyperlink{namespacehmap_a6b608e2826c1f9ba54a0e8922d5faa6b}{sqrt}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00503\ }
\DoxyCodeLine{00504\ Array\ \mbox{\hyperlink{namespacehmap_a30e6961ce99edeb86af6f4ce61651bd0}{sqrt\_safe}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00505\ }
