...
\DoxyCodeLine{00310\ }
\DoxyCodeLine{00335\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ad0759b7e3cb7455527b9b5b4947720bd}{sigmoid}}(\textcolor{keywordtype}{float}\ x,}
\DoxyCodeLine{00336\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ width\ =\ 1.f,}
\DoxyCodeLine{00337\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,}
\DoxyCodeLine{00338\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f,}
\DoxyCodeLine{00339\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ x0\ =\ 0.f);}
\DoxyCodeLine{00340\ }
\DoxyCodeLine{00366\ Array\ \mbox{\hyperlink{namespacehmap_ad0759b7e3cb7455527b9b5b4947720bd}{sigmoid}}(\textcolor{keyword}{const}\ Array\ \&array,}
\DoxyCodeLine{00367\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ width\ =\ 1.f,}
\DoxyCodeLine{00368\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ vmin\ =\ 0.f,}
\DoxyCodeLine{00369\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ vmax\ =\ 1.f,}
\DoxyCodeLine{00370\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{float}\ \ \ \ \ \ \ \ x0\ =\ 0.f);}
\DoxyCodeLine{00371\ }
\DoxyCodeLine{00378\ Array\ \mbox{\hyperlink{namespacehmap_a03359e722d96524598aa525022317c95}{sin}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00379\ }
\DoxyCodeLine{00394\ Array\ \mbox{\hyperlink{namespacehmap_a413648e2595721d8ba4096357dbb1f84}{smoothstep3}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,\ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f);}
\DoxyCodeLine{00395\ }
\DoxyCodeLine{00402\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_a413648e2595721d8ba4096357dbb1f84}{smoothstep3}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00403\ }
\DoxyCodeLine{00411\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_a4c21ef9d4f7d33f2413c7fe391b86253}{smoothstep3\_lower}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00412\ Array\ \mbox{\hyperlink{namespacehmap_a4c21ef9d4f7d33f2413c7fe391b86253}{smoothstep3\_lower}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00413\ }
\DoxyCodeLine{00421\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_af23a6099bd3307b408f17d2346ab3d3f}{smoothstep3\_upper}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00422\ Array\ \mbox{\hyperlink{namespacehmap_af23a6099bd3307b408f17d2346ab3d3f}{smoothstep3\_upper}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00423\ }
\DoxyCodeLine{00438\ Array\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keyword}{const}\ Array\ \&array,\ \textcolor{keywordtype}{float}\ vmin\ =\ 0.f,\ \textcolor{keywordtype}{float}\ vmax\ =\ 1.f);}
\DoxyCodeLine{00439\ Array\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keyword}{const}\ Array\ \&array,}
\DoxyCodeLine{00440\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Array\ \&vmin,}
\DoxyCodeLine{00441\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Array\ \&vmax);\ }
\DoxyCodeLine{00442\ }
\DoxyCodeLine{00449\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aa4468d1e57ee67ba0be8fb1ab931045a}{smoothstep5}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00450\ }
\DoxyCodeLine{00458\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ac3a402abb2905ac02f1756c0b36e971c}{smoothstep5\_lower}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00459\ Array\ \mbox{\hyperlink{namespacehmap_ac3a402abb2905ac02f1756c0b36e971c}{smoothstep5\_lower}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00460\ }
\DoxyCodeLine{00468\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_aae372587e98d5acb969a89a5f0661019}{smoothstep5\_upper}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00469\ Array\ \mbox{\hyperlink{namespacehmap_aae372587e98d5acb969a89a5f0661019}{smoothstep5\_upper}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00470\ }
\DoxyCodeLine{00477\ \textcolor{keywordtype}{float}\ \mbox{\hyperlink{namespacehmap_ae7d9d43c2cd453af7a6395cbcb2ac3b2}{smoothstep7}}(\textcolor{keywordtype}{float}\ x);}
\DoxyCodeLine{00478\ Array\ \mbox{\hyperlink{namespacehmap_ae7d9d43c2cd453af7a6395cbcb2ac3b2}{smoothstep7}}(\textcolor{keyword}{const}\ Array\ \&x);\ }
\DoxyCodeLine{00479\ }
\DoxyCodeLine{00486\ Array\ \mbox{\hyperlink{namespacehmap_a6b608e2826c1f9ba54a0e8922d5faa6b}{sqrt}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00487\ }
\DoxyCodeLine{00488\ Array\ \mbox{\hyperlink{namespacehmap_a30e6961ce99edeb86af6f4ce61651bd0}{sqrt\_safe}}(\textcolor{keyword}{const}\ Array\ \&array);}
\DoxyCodeLine{00489\ }
\DoxyCodeLine{00490\ \}\ \textcolor{comment}{//\ namespace\ hmap}}
