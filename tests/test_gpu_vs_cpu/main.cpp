...
int main(void)
{
  ...
  compare([&ir](hmap::Array &z) { z = hmap::local_max(z, ir); },
          [&ir](hmap::Array &z) { z = hmap::gpu::local_max(z, ir); },
          1e-3f,
          "local_max");
  ...
  compare([&ir](hmap::Array &z) { z = hmap::local_min(z, ir); },
          [&ir](hmap::Array &z) { z = hmap::gpu::local_min(z, ir); },
          1e-3f,
          "local_min");
